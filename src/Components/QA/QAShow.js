      ...
      answers: [
         {
            ...
            positiveAnswer: '20',
            negativeAnswer: '3',
            body: '<p>متغییر env رو توی فایلت تغییر بده درست میشه</p>'
         },
         {
            id: 2,
            title: 'مجتبی جمشیدی',
...

            {
               this.state.answers.map(item =>
                  <QA key={item.id} data={item}>
                     <div className='flex'>
                        <Button link={`/`} bColor='border-mainBorderColor' hColor='hover:text-mainRedColor' bgHoverColor='hover:bg-gray-100' color='text-mainRedColor'> 
                        ...
                        <Button link={`/`} bColor='border-mainBorderColor' hColor='hover:text-mainGreenColor' bgHoverColor='hover:bg-gray-100' color='text-mainGreenColor'> 
